...
const nyyPackages: SeasonPackage[] = [
  ...
  },
  {
    ...
    gameCount: 10,
    description:
      'Build your own plan — mix of Bronze, Silver, and Gold tier games',
...
const tbPackages: SeasonPackage[] = [
  ...
  },
  {
    ...
    gameCount: 20,
    description:
      '11 weekday, 3 Friday, 3 Saturday, 3 Sunday pre-selected games',
    gameSelection: 'curated',
  },
  {
    id: 'tb-fans-choice',
...
const cwsPackages: SeasonPackage[] = [
  ...
  },
  {
    ...
    name: 'Half Season Plan',
    description:
      '~40 games, split between weekend-heavy and weekday-heavy options',
  },
  {
    id: 'cws-20',
    name: '20-Game Plan',
...
const minPackages: SeasonPackage[] = [
  ...
  },
  {
    ...
    gameCount: 81,
    description:
      'Standing-room ballpark access to every home game for $229/season or $49/month',
    gameSelection: 'all',
    gameFilter: { all: true },
  },
];
...
const oakPackages: SeasonPackage[] = [
  ...
  },
  {
    ...
    gameCount: 13,
    description:
      'All Sunday home games — includes 4 tickets, 4 drinks, 4 hot dogs',
    gameSelection: 'day_of_week',
...
const seaPackages: SeasonPackage[] = [
  ...
  },
  {
    ...
    gameCount: 15,
    description:
      '$2,000 credit — 15% discount on single-game tickets, use on any games',
    gameSelection: 'flexible',
  },
  {
    id: 'sea-flex-rookie',
    ...
    gameCount: 10,
    description:
      '$1,000 credit — 10% discount on single-game tickets, use on any games',
    gameSelection: 'flexible',
  },
];
...
const miaPackages: SeasonPackage[] = [
  ...
  },
  {
    ...
    gameCount: 10,
    description:
      'Spend credit on any games, bring any number of guests — 6 tiers from $750+',
    gameSelection: 'flexible',
  },
];
...
const wshPackages: SeasonPackage[] = [
  {
    ...
    name: 'Full Season Plan',
    description:
      'All 81 home games at Nationals Park — 30% savings on concessions/merch',
  },
  {
    id: 'wsh-quarter-fri',
...
const chcPackages: SeasonPackage[] = [
  ...
  },
  {
    ...
    gameCount: 20,
    description:
      '10-40 games focused on specific months, weekends, or premium opponents',
    gameSelection: 'curated',
  },
];
...
const cinPackages: SeasonPackage[] = [
  ...
  },
  {
    ...
    gameCount: 10,
    description:
      'Block of ticket credits to deploy on any regular-season games',
    gameSelection: 'flexible',
  },
  {
    id: 'cin-pick6',
...
const milPackages: SeasonPackage[] = [
  {
    ...
    name: 'Full Season Membership',
    description:
      'All 81 home games at American Family Field — includes starter jacket',
  },
  {
    id: 'mil-40',
    name: '40-Game Membership',
  ...
  },
  {
    ...
    gameCount: 12,
    description:
      '12 weekend games + free Opening Day — 20% off single-game prices',
    gameSelection: 'day_of_week',
    gameFilter: { weekendsOnly: true, dayOfWeek: [0, 5, 6] },
  },
  {
    ...
    gameCount: 12,
    description:
      '12 Friday games + free Opening Day — 20% off single-game prices',
    gameSelection: 'day_of_week',
    gameFilter: { fridays: true, dayOfWeek: [5] },
  },
  {
    ...
    gameCount: 12,
    description:
      '12 premium matchup games + free Opening Day — 20% off single-game prices',
    gameSelection: 'opponents',
  },
  {
    id: 'mil-12-afternoon',
    ...
    gameCount: 12,
    description:
      '12 afternoon/day games + free Opening Day — 20% off single-game prices',
    gameSelection: 'curated',
  },
  {
    id: 'mil-6-friday',
...
const sfPackages: SeasonPackage[] = [
  ...
  },
  {
    ...
    gameCount: 13,
    description:
      'Games against NL West divisional rivals (Dodgers, Padres, etc.)',
    gameSelection: 'opponents',
  },
  {
    id: 'sf-theme',
