...
export default function PrivacyPolicy() {
  return (
    <>
      ...
      <p>
        BenchBuddy (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) is
        committed to protecting your privacy. This Privacy Policy explains how
        we collect, use, share, and protect your personal information when you
        use the BenchBuddy website, mobile application, or any related services
      ...
      <ul>
        ...
        <li>
          <strong>Set up your profile:</strong> profile photo, phone number, and
          payment app usernames (e.g., Venmo handle) that you choose to share
          with your Sharing Circle members
        </li>
        <li>
          <strong>Create or join a Sharing Circle:</strong> season ticket
          details, seat information, face-value pricing, and game availability
          preferences
        </li>
        <li>
          <strong>Use the Service:</strong> game selections, claim requests,
          messages, and other content you submit within the platform
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          taken, time spent on pages, and referring URLs
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          Facilitate Sharing Circle coordination and game claim management
        </li>
        <li>
          Display cost-sharing calculations based on face-value ticket prices
        </li>
        <li>
          Send you important notifications about your account, Sharing Circles,
          and game claims
        </li>
        <li>
          Send you marketing communications (with your consent, and you may opt
          out at any time)
        </li>
      ...
      <p>
        BenchBuddy does not sell, rent, or trade your personal information to
        third parties for their marketing purposes. We have never sold personal
        information and will not do so in the future.
      </p>

      <h3>Sharing with Sharing Circle Members</h3>
      <p>
        When you join a Sharing Circle, certain information is shared with other
        members of that Circle to facilitate coordination. This may include your
        name, profile photo, game selections, and any payment app usernames you
        have chosen to share. You control what optional information you add to
        your profile.
      </p>
      ...
      <p>
        ...
        who assist us in operating the Service, including:
      </p>
      <ul>
      ...
      <p>
        These providers are contractually obligated to use your information only
        as necessary to provide their services to us and are required to
      ...
      <p>
        If BenchBuddy is involved in a merger, acquisition, reorganization, or
      ...
      <p>
        ...
        and improve the Service. For detailed information about the cookies we
        use and how to manage your preferences, please see our Cookie Policy.
      </p>
      ...
      <ul>
        <li>
          ...
          collected about you, the categories of sources, the business purposes
          for collection, and the categories of third parties with whom we share
          your information.
        </li>
        <li>
      ...
      <p>
        ...
        hello@getbenchbuddy.com. We will verify your identity before processing
        your request.
      </p>
      ...
      <p>
        ...
        active or as needed to provide you the Service. We may also retain your
      ...
      <p>
        ...
        retain certain data for a longer period.
      </p>
      ...
      <p>
        The Service may contain links to third-party websites, applications, or
        services that are not owned or controlled by BenchBuddy, including
        official team ticketing apps, payment platforms, and social media sites.
      ...
      <p>
        ...
        updating the &quot;Last Updated&quot; date. We may also send you an
        email notification for significant changes. Your continued use of the
