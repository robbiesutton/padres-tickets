...
const EMAILS = [
  {
    id: '1',
    label: '#1 Holder welcome',
    file: '/emails/email-1-holder-welcome.html',
  },
  {
    id: '2',
    label: '#2 Claimer welcome',
    file: '/emails/email-2-claimer-welcome.html',
  },
  {
    id: '3',
    label: '#3 Holder: game claimed',
    file: '/emails/email-3-holder-game-claimed.html',
  },
  {
    id: '4',
    label: '#4 Claimer: claim confirmation',
    file: '/emails/email-4-claimer-claim-confirmation.html',
  },
  {
    id: '5',
    label: '#5 Claimer: game day',
    file: '/emails/email-5-claimer-game-day.html',
  },
  {
    id: '6a',
    label: '#6a Holder: game day (claimed)',
    file: '/emails/email-6a-holder-gameday-claimed.html',
  },
  {
    id: '6b',
    label: '#6b Holder: game day (available)',
    file: '/emails/email-6b-holder-gameday-available.html',
  },
  {
    id: '6c',
    label: '#6c Holder: game day (going)',
    file: '/emails/email-6c-holder-gameday-going.html',
  },
  {
    id: '7',
    label: '#7 Claimer: game unclaimed',
    file: '/emails/email-7-claimer-game-unclaimed.html',
  },
];
...
export default function EmailPreviewPage() {
  ...
  useEffect(() => {
    fetch(email.file)
      ...
      .catch(() =>
        setHtml(
          '<p style="color:#999;text-align:center;padding:40px;">Failed to load email template</p>'
        )
      );
  }, [email.file]);
